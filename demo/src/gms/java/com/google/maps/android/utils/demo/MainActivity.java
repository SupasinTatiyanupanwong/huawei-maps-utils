...
package me.tatiyanupanwong.supasin.android.samples.huawei.maps.utils;
...
<<<<<<<< HEAD:demo/src/main/java/me/tatiyanupanwong/supasin/android/samples/huawei/maps/utils/MainActivity.java
========
        if (BuildConfig.MAPS_API_KEY.isEmpty()) {
            Toast.makeText(this, "Add your own API key in local.properties as MAPS_API_KEY=YOUR_API_KEY", Toast.LENGTH_LONG).show();
        }

>>>>>>>> v2.4.1:demo/src/gms/java/com/google/maps/android/utils/demo/MainActivity.java
