...
import dev.supasintatiyanupanwong.libraries.android.huawei.maps.utils.clustering.Cluster;
import dev.supasintatiyanupanwong.libraries.android.huawei.maps.utils.clustering.ClusterItem;
...
public class ZoomClusteringDemoActivity extends BaseDemoActivity implements ClusterManager.OnClusterClickListener<MyItem>, ClusterManager.OnClusterInfoWindowClickListener<MyItem>, ClusterManager.OnClusterItemClickListener<MyItem>, ClusterManager.OnClusterItemInfoWindowClickListener<MyItem> {
    ...
    private class ZoomBasedRenderer extends DefaultClusterRenderer<MyItem> implements HuaweiMap.OnCameraIdleListener {
        private Float zoom = 15f;
        private Float oldZoom;
        private static final float ZOOM_THRESHOLD = 12f;

        public ZoomBasedRenderer(Context context, HuaweiMap map, ClusterManager<MyItem> clusterManager) {
            super(context, map, clusterManager);
        }

        /**
         * The {@link ClusterManager} will call the {@link this.onCameraIdle()} implementation of
         * any Renderer that implements {@link HuaweiMap.OnCameraIdleListener} <i>before</i>
